...
function getCurrentWeather(lat, lng) {
    ...
    return fetch(url, {
        ...
        .then(function (data) { return data.data.timelines[0].intervals[0].values; })
...
function getWeekReport(lat, lng) {
    ...
    return fetch(url, {
        ...
        .then(function (response) { return response.json(); })
        .then(function (data) { return data.data.timelines[0].intervals; })
        .catch(function (error) {
...
function getWeatherDetails(lat, lng, date) {
    ...
    return fetch(url, {
        ...
        .then(function (response) { return response.json(); })
        .then(function (data) { return data.data.timelines[0].intervals[0]; })
        .catch(function (error) {
...
module.exports = {
    ...
    getTemperatureTimeline: getTemperatureTimeline,
